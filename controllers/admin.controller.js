...
console.log(tokenapi.data.access_token,"tokenapitokenapi")
        ...
        console.log(random,"---=-=-=")
            const newapi = await axios.post(
                `https://${AUTH_TOKEN_DOMAIN}/api/v2/users`,
                {
            ...
            const passApi = await axios.post(
                `https://${AUTH_TOKEN_DOMAIN}/dbconnections/change_password`,
                {
            ...
            const roleApi = await axios.get(
                `https://${AUTH_TOKEN_DOMAIN}/api/v2/roles`,
                {
                    headers: {
                        'Authorization': `Bearer ${newtoken}`,
                        'Content-Type': 'application/json',
          ...
          console.log(desiredrole,"00000000")
           ...
           const assignrole = await axios.post(
            `https://${AUTH_TOKEN_DOMAIN}/api/v2/roles/${desiredrole.id}/users`,
            {
