...
>>>>>>> 26fc265a23c765bd120492976b6db99060ce7eae
            ...
            .then((data) => {
                axios
                    ...
                    .then(async (result) => {
                        ...
                        if (useremail) {
                            securityhealthcount =
                                await customerSecurityChecklist.count({
                                    where: {
                                        email: useremail,
                                        status: 1,
                                    },
                        ...
                        const activeObjects = newdata?.filter(
                            (obj) => obj.controlName === "UserRiskPolicy"
                        );
                        //console.log(activeObjects, "activeObjectsactiveObjects")
                        console.log(securityhealthcount, "-=-=-=");
                        const activestatus = result.data.value;
                        const activeObjects1 = activestatus.filter(
                            (obj) => obj.status === "active"
                        );
                        let overallcount =
                            activeObjects1.length + securityhealthcount;
...
<<<<<<< HEAD
            ...
            const activeObjects = activestatus.filter(
                (obj) => obj.status === "active"
            );
...
<<<<<<< HEAD
            ...
            if (data && data.value && Array.isArray(data.value)) {
                ...
                data.value.forEach((item) => {
                    ...
                    const filteredScores = item.controlScores
                        .filter((obj) => obj.controlName === "UserRiskPolicy")
